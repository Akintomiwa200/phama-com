...
// ── Inline seed data (generated from export-data.mjs) ──────────────────────

const patients = [
  {
    id: "PT-72819", name: "Mrs. Folake E.", age: 72, gender: "F", bloodType: "O+", height: 162,
  ...
  {
    id: "PT-72820", name: "Mr. Emmanuel O.", age: 65, gender: "M", bloodType: "A+", height: 175,
  ...
  {
    id: "PT-72821", name: "Miss Ngozi I.", age: 28, gender: "F", bloodType: "B+", height: 165,
  ...
  {
    id: "PT-72822", name: "Mr. Chidi O.", age: 45, gender: "M", bloodType: "AB+", height: 180,
  ...
  {
    id: "PT-72823", name: "Mrs. Amara K.", age: 35, gender: "F", bloodType: "O-", height: 168,
  ...
  {
    id: "PT-72824", name: "Chief Bayo A.", age: 80, gender: "M", bloodType: "A-", height: 170,
  ...
  {
    id: "PT-72825", name: "Miss Zainab B.", age: 22, gender: "F", bloodType: "B-", height: 160,
  ...
  {
    id: "PT-72826", name: "Mr. Emeka O.", age: 48, gender: "M", bloodType: "O+", height: 183,
  ...
  {
    id: "PT-72827", name: "Mrs. Yemisi D.", age: 62, gender: "F", bloodType: "A+", height: 164,
  ...
  {
    id: "PT-72828", name: "Mr. Adewale B.", age: 30, gender: "M", bloodType: "AB-", height: 178,
...
const interactions = [
  { drug1: "Amlodipine", drug2: "Simvastatin", severity: "HIGH", effect: "High risk of muscle damage (rhabdomyolysis) and kidney failure", mechanism: "Amlodipine inhibits CYP3A4, increasing simvastatin plasma levels 3-7x", action: "Contact prescriber before dispensing. Consider switching to Rosuvastatin.", references: "MHRA 2012; NICE CG181" },
  { drug1: "Warfarin", drug2: "Aspirin", severity: "HIGH", effect: "Significantly increased bleeding risk including life-threatening haemorrhage", mechanism: "Additive anticoagulant and antiplatelet effects", action: "Avoid combination unless benefit clearly outweighs risk. Monitor INR closely.", references: "BNF 2024; WHO Essential Medicines" },
  { drug1: "Metformin", drug2: "Contrast Dye", severity: "MODERATE", effect: "Risk of lactic acidosis post-contrast procedure", mechanism: "Renal impairment from contrast reduces metformin clearance", action: "Hold metformin 48hrs before and after contrast imaging", references: "ACR Manual on Contrast Media 2023" },
  { drug1: "Lisinopril", drug2: "Potassium", severity: "MODERATE", effect: "Hyperkalaemia — can cause cardiac arrhythmias", mechanism: "ACE inhibitors reduce aldosterone; potassium supplementation compounds the rise", action: "Monitor serum potassium. Avoid high-potassium foods and supplements.", references: "BNF 2024" },
  { drug1: "Artemether", drug2: "Halofantrine", severity: "CONTRAINDICATED", effect: "Potentially fatal QT prolongation and cardiac arrhythmia", mechanism: "Both drugs prolong QT interval; additive effect", action: "Do not co-administer. Use alternative antimalarials.", references: "WHO Malaria Treatment Guidelines 2022" },
  { drug1: "Warfarin", drug2: "Ciprofloxacin", severity: "HIGH", effect: "Increased INR and bleeding risk", mechanism: "Ciprofloxacin inhibits CYP1A2, reducing warfarin metabolism", action: "Monitor INR closely; consider reducing warfarin dose.", references: "BNF 2024" },
  { drug1: "Flucloxacillin", drug2: "Methotrexate", severity: "HIGH", effect: "Severe methotrexate toxicity", mechanism: "Flucloxacillin reduces methotrexate renal clearance", action: "Avoid combination; consider alternative antibiotic.", references: "MHRA 2020" },
  { drug1: "Enalapril", drug2: "Spironolactone", severity: "MODERATE", effect: "Risk of hyperkalaemia", mechanism: "Dual RAAS blockade reduces potassium excretion", action: "Monitor serum potassium regularly; caution in CKD patients.", references: "BNF 2024" },
  { drug1: "Furosemide", drug2: "Gentamicin", severity: "MODERATE", effect: "Increased risk of ototoxicity and nephrotoxicity", mechanism: "Additive toxicity on cochlear and renal cells", action: "Monitor renal function and hearing; consider dose adjustment.", references: "WHO Essential Medicines 2022" },
  { drug1: "Salbutamol", drug2: "Atenolol", severity: "MODERATE", effect: "Beta-blocker may antagonise bronchodilator effect of salbutamol", mechanism: "Competitive blockade of beta-2 receptors", action: "Use cardioselective beta-blocker with caution; monitor lung function.", references: "BNF 2024" },
];

const cascadePatterns = [
  { causeDrug: "Lisinopril", sideEffect: "Dry cough (10-20% of patients)", newDrug: "Amlodipine", cascadeRisk: "Amlodipine is sometimes added for blood pressure control when Lisinopril cough occurs, instead of switching to an ARB.", recommendation: "Confirm with prescriber: Does patient have Lisinopril-induced cough? If yes, consider switching to Losartan (ARB) rather than adding Amlodipine." },
  { causeDrug: "NSAIDs", sideEffect: "GI irritation / peptic ulcer", newDrug: "Omeprazole", cascadeRisk: "PPI prescribed to treat NSAID-induced GI side effects rather than stopping the NSAID", recommendation: "Review necessity of NSAID. Consider Paracetamol if appropriate. If NSAID essential, prescribe PPI with shortest effective duration." },
  { causeDrug: "Thiazide diuretics", sideEffect: "Gout attacks", newDrug: "Allopurinol", cascadeRisk: "Allopurinol prescribed for gout triggered by thiazide diuretics", recommendation: "Consider switching diuretic class. Review whether thiazide is the most appropriate agent." },
  { causeDrug: "Metformin", sideEffect: "GI intolerance / diarrhoea", newDrug: "Metformin MR (modified release)", cascadeRisk: "Modified release metformin prescribed for GI side effects rather than dose titration or review of carbohydrate intake", recommendation: "Titrate standard metformin gradually over 4 weeks before switching to MR formulation." },
  { causeDrug: "Salmeterol (LABA)", sideEffect: "Inadequate asthma control", newDrug: "Montelukast", cascadeRisk: "Montelukast added for persisting symptoms without checking inhaler technique or adherence", recommendation: "Assess inhaler technique and adherence before adding third-line therapy. Consider stepping up ICS dose." },
];

const pharmacists = [
  { id: "PANS2024", name: "Dr. Adaobi Nnamdi", licenseNumber: "PHARM-NG-2024-001", authorized: true },
  { id: "PANS2025", name: "Dr. Chidi Okonkwo", licenseNumber: "PHARM-NG-2025-002", authorized: true },
  { id: "PANS2026", name: "Dr. Emeka Nwosu", licenseNumber: "PHARM-NG-2026-003", authorized: true },
  { id: "PANS2027", name: "Dr. Fatima Bello", licenseNumber: "PHARM-NG-2027-004", authorized: true },
  { id: "PANS2028", name: "Dr. Kunle Hassan", licenseNumber: "PHARM-NG-2028-005", authorized: true },
  { id: "PANS9999", name: "Unauthorized User", licenseNumber: "INVALID", authorized: false },
];

const prescriptions = [
  { rxId: "RX-2026-0521-001", patientId: "PT-72819", patientName: "Mrs. Folake E.", drug: "Amlodipine", strength: "10mg", quantity: 30, frequency: "Once daily", route: "Oral", prescriber: "Dr. Adeyemi (Cardiologist)", ward: "Cardiology Ward B", priority: "ROUTINE", status: "PENDING", time: "09:15" },
  { rxId: "RX-2026-0521-002", patientId: "PT-72821", patientName: "Miss Ngozi I.", drug: "Artemether-Lumefantrine", strength: "20/120mg", quantity: 24, frequency: "Twice daily x3 days", route: "Oral", prescriber: "Dr. Bello (Internist)", ward: "Obstetrics", priority: "URGENT", status: "PENDING", time: "09:32" },
  { rxId: "RX-2026-0521-003", patientId: "PT-72820", patientName: "Mr. Emmanuel O.", drug: "Apixaban", strength: "5mg", quantity: 56, frequency: "Twice daily", route: "Oral", prescriber: "Dr. Hassan (Cardiologist)", ward: "Internal Medicine", priority: "ROUTINE", status: "PENDING", time: "10:05" },
  { rxId: "RX-2026-0521-004", patientId: "PT-72827", patientName: "Mrs. Yemisi D.", drug: "Furosemide", strength: "40mg", quantity: 60, frequency: "Twice daily", route: "IV", prescriber: "Dr. Adeyemi (Cardiologist)", ward: "Cardiology ICU", priority: "URGENT", status: "PENDING", time: "10:30" },
  { rxId: "RX-2026-0521-005", patientId: "PT-72826", patientName: "Mr. Emeka O.", drug: "Enoxaparin", strength: "40mg", quantity: 10, frequency: "Once daily", route: "Subcutaneous", prescriber: "Dr. Okoro (Orthopaedic Surgeon)", ward: "Orthopaedics", priority: "ROUTINE", status: "PENDING", time: "11:00" },
  { rxId: "RX-2026-0521-006", patientId: "PT-72825", patientName: "Miss Zainab B.", drug: "Ceftriaxone", strength: "1g", quantity: 7, frequency: "Once daily", route: "IV", prescriber: "Dr. Bello (Internist)", ward: "General Medicine", priority: "URGENT", status: "PENDING", time: "11:15" },
];
...
const drugs = [
  { barcode: "123456789012", name: "Amlodipine", strength: "5mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "123456789013", name: "Amlodipine", strength: "10mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "234567890123", name: "Metformin", strength: "500mg", form: "Tablet", instructions: "Take twice daily with meals" },
  { barcode: "234567890124", name: "Metformin", strength: "850mg", form: "Tablet", instructions: "Take twice daily with meals" },
  { barcode: "345678901234", name: "Simvastatin", strength: "20mg", form: "Tablet", instructions: "Take once nightly" },
  { barcode: "456789012345", name: "Lisinopril", strength: "10mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "567890123456", name: "Artemether", strength: "20mg", form: "Injection", instructions: "Administer as per protocol" },
  { barcode: "567890123457", name: "Artemether-Lumefantrine", strength: "20/120mg", form: "Tablet", instructions: "Take twice daily x3 days" },
  { barcode: "678901234567", name: "Warfarin", strength: "5mg", form: "Tablet", instructions: "Take once daily at same time" },
  { barcode: "789012345678", name: "Ferrous Sulphate", strength: "200mg", form: "Tablet", instructions: "Take three times daily" },
  { barcode: "890123456789", name: "Amoxicillin", strength: "250mg", form: "Capsule", instructions: "Take three times daily" },
  { barcode: "890123456790", name: "Amoxicillin", strength: "500mg", form: "Capsule", instructions: "Take three times daily" },
  { barcode: "901234567890", name: "Ceftriaxone", strength: "1g", form: "Injection", instructions: "Administer once daily IV/IM" },
  { barcode: "012345678901", name: "Tramadol", strength: "50mg", form: "Capsule", instructions: "Take three times daily as needed for pain" },
  { barcode: "112345678901", name: "Omeprazole", strength: "20mg", form: "Capsule", instructions: "Take once daily before food" },
  { barcode: "212345678901", name: "Salbutamol", strength: "100mcg", form: "Inhaler", instructions: "Use as needed (PRN)" },
  { barcode: "212345678902", name: "Fluticasone/Salmeterol", strength: "250/50mcg", form: "Inhaler", instructions: "Inhale twice daily" },
  { barcode: "312345678901", name: "Insulin Glargine", strength: "100 IU/mL", form: "Injection", instructions: "Inject once nightly" },
  { barcode: "312345678902", name: "Insulin Lispro", strength: "100 IU/mL", form: "Injection", instructions: "Inject with meals" },
  { barcode: "412345678901", name: "Furosemide", strength: "40mg", form: "Tablet", instructions: "Take twice daily" },
  { barcode: "412345678902", name: "Furosemide", strength: "20mg", form: "Injection", instructions: "Administer IV" },
  { barcode: "512345678901", name: "Paracetamol", strength: "500mg", form: "Tablet", instructions: "Take 1-2 tablets every 4-6 hours" },
  { barcode: "512345678902", name: "Paracetamol", strength: "1g", form: "Tablet", instructions: "Take four times daily" },
  { barcode: "612345678901", name: "Atenolol", strength: "50mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "712345678901", name: "Allopurinol", strength: "100mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "812345678901", name: "Spironolactone", strength: "25mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "912345678901", name: "Enalapril", strength: "5mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "013345678901", name: "Atorvastatin", strength: "40mg", form: "Tablet", instructions: "Take once nightly" },
  { barcode: "113345678901", name: "Donepezil", strength: "10mg", form: "Tablet", instructions: "Take once nightly" },
  { barcode: "213345678901", name: "Tamsulosin", strength: "0.4mg", form: "Capsule", instructions: "Take once daily" },
  { barcode: "313345678901", name: "Latanoprost", strength: "0.005%", form: "Eye Drops", instructions: "Instill one drop nightly" },
  { barcode: "413345678901", name: "Montelukast", strength: "10mg", form: "Tablet", instructions: "Take once nightly" },
  { barcode: "513345678901", name: "Cetirizine", strength: "10mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "613345678901", name: "Levothyroxine", strength: "75mcg", form: "Tablet", instructions: "Take once daily on empty stomach" },
  { barcode: "713345678901", name: "Erythropoietin", strength: "4000 IU", form: "Injection", instructions: "Inject weekly" },
  { barcode: "813345678901", name: "Calcium Carbonate", strength: "500mg", form: "Tablet", instructions: "Take three times daily with meals" },
  { barcode: "913345678901", name: "Enoxaparin", strength: "40mg", form: "Injection", instructions: "Inject once daily" },
  { barcode: "014345678901", name: "Apixaban", strength: "5mg", form: "Tablet", instructions: "Take twice daily" },
  { barcode: "114345678901", name: "Folic Acid", strength: "5mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "214345678901", name: "Ibuprofen", strength: "400mg", form: "Tablet", instructions: "Take three times daily with food" },
  { barcode: "314345678901", name: "Diclofenac", strength: "50mg", form: "Tablet", instructions: "Take three times daily with food" },
  { barcode: "414345678901", name: "Prednisolone", strength: "40mg", form: "Tablet", instructions: "Take once daily as directed" },
  { barcode: "514345678901", name: "Risperidone", strength: "0.5mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "614345678901", name: "Bisoprolol", strength: "2.5mg", form: "Tablet", instructions: "Take once daily" },
  { barcode: "714345678901", name: "Colchicine", strength: "500mcg", form: "Tablet", instructions: "Take as directed" },
  { barcode: "814345678901", name: "Nitrofurantoin", strength: "100mg", form: "Capsule", instructions: "Take twice daily" },
  { barcode: "914345678901", name: "Doxycycline", strength: "100mg", form: "Capsule", instructions: "Take twice daily" },
  { barcode: "015345678901", name: "Ciprofloxacin", strength: "500mg", form: "Tablet", instructions: "Take twice daily" },
  { barcode: "115345678901", name: "Flucloxacillin", strength: "500mg", form: "Capsule", instructions: "Take four times daily" },
  { barcode: "215345678901", name: "Methotrexate", strength: "2.5mg", form: "Tablet", instructions: "Take once weekly" },
  { barcode: "315345678901", name: "Gentamicin", strength: "80mg", form: "Injection", instructions: "Administer as per protocol" },
  { barcode: "415345678901", name: "Halofantrine", strength: "250mg", form: "Tablet", instructions: "Take as directed for malaria" },
];

const auditLog = [
  { timestamp: "09:15:22", action: "Pharmacist logged in", details: "ID: PANS2024", pharmacistId: "PANS2024", patientId: "" },
  { timestamp: "09:15:45", action: "Prescription received", details: "Patient: Mrs. Folake E. | Drug: Amlodipine 10mg", pharmacistId: "PANS2024", patientId: "PT-72819" },
  { timestamp: "09:16:05", action: "Interaction detected", details: "Amlodipine + Simvastatin: High risk", pharmacistId: "PANS2024", patientId: "PT-72819" },
  { timestamp: "09:16:40", action: "Prescription dispensed", details: "Amlodipine 10mg — 30 tablets", pharmacistId: "PANS2024", patientId: "PT-72819" },
  { timestamp: "09:17:00", action: "Pharmacist logged out", details: "ID: PANS2024", pharmacistId: "PANS2024", patientId: "" },
];

const collections = {
  pharmacists: { data: pharmacists, idField: "id" },
  prescriptions: { data: prescriptions, idField: "rxId" },
  inventory: { data: inventory, idField: "barcode" },
  patients: { data: patients.map(({ currentMedications, recentVitals, labReports, medicalHistory, prescriptionHistory, ...rest }) => ({ ...rest, currentMedications: currentMedications || [], recentVitals: recentVitals || {}, labReports: labReports || [], medicalHistory: medicalHistory || [], prescriptionHistory: prescriptionHistory || [] })), idField: "id" },
  drug_interactions: { data: interactions, idField: null },
  cascade_patterns: { data: cascadePatterns, idField: null },
  drugs: { data: drugs, idField: "barcode" },
  audit_log: { data: auditLog, idField: null },
};
...
try {
  ...
  console.log("\nAll collections seeded successfully from inline data.");
} catch (err) {
