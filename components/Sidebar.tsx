...
export default function Sidebar() {
  ...
  return (
    <aside style={{
      width: state.sidebarOpen ? 220 : 64,
      minHeight: "100vh",
      ...
      {/* Logo */}
      <div style={{
        padding: state.sidebarOpen ? "20px 16px" : "20px 16px",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      gap: 10, padding: state.sidebarOpen ? "9px 16px" : "9px 16px",
      ...
      {state.pharmacist && (
        <div style={{
          padding: state.sidebarOpen ? "12px 16px" : "12px 12px",
      ...
      >
        {state.sidebarOpen ? <ChevronLeft size={12} /> : <ChevronRight size={12} />}
      </button>
    </aside>
  );
}
